...
#
# Generated by Vivado on Tue Oct 24 18:40:13 CST 2023
...
set script_file "vvd_caravel_fsic.tcl"
...
set file "$origin_dir/vvd_srcs/caravel_soc/rtl/user/mprj_io/rtl/mprj_io.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
# module references:
# AXIS_SWz, IO_SERDESz, aa_wrapper, caravel, ps_axil, ps_is_wrapper, spiflash
  ...
  # Create instance: AXIS_SWz_0, and set properties
  set block_name AXIS_SWz
  set block_cell_name AXIS_SWz_0
  if { [catch {set AXIS_SWz_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AXIS_SWz_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: IO_SERDESz_0, and set properties
  set block_name IO_SERDESz
  set block_cell_name IO_SERDESz_0
  if { [catch {set IO_SERDESz_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $IO_SERDESz_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: aa_wrapper_0, and set properties
  set block_name aa_wrapper
  set block_cell_name aa_wrapper_0
  if { [catch {set aa_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $aa_wrapper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {924.807} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {10} \
   CONFIG.CLKOUT2_JITTER {723.030} \
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  # Create instance: ps_is_wrapper_0, and set properties
  set block_name ps_is_wrapper
  set block_cell_name ps_is_wrapper_0
  if { [catch {set ps_is_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ps_is_wrapper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net AXIS_SWz_0_as_aa [get_bd_intf_pins AXIS_SWz_0/as_aa] [get_bd_intf_pins aa_wrapper_0/as_aa]
  connect_bd_intf_net -intf_net AXIS_SWz_0_as_is [get_bd_intf_pins AXIS_SWz_0/as_is] [get_bd_intf_pins IO_SERDESz_0/as_is]
  connect_bd_intf_net -intf_net IO_SERDESz_0_is_as [get_bd_intf_pins AXIS_SWz_0/is_as] [get_bd_intf_pins IO_SERDESz_0/is_as]
  connect_bd_intf_net -intf_net aa_wrapper_0_aa_as [get_bd_intf_pins AXIS_SWz_0/aa_as] [get_bd_intf_pins aa_wrapper_0/aa_as]
  ...
  connect_bd_net -net AXIS_SWz_0_axi_arready [get_bd_pins AXIS_SWz_0/axi_arready] [get_bd_pins ps_axil_0/axi_arready0]
  connect_bd_net -net AXIS_SWz_0_axi_awready [get_bd_pins AXIS_SWz_0/axi_awready] [get_bd_pins ps_axil_0/axi_awready0]
  connect_bd_net -net AXIS_SWz_0_axi_rdata [get_bd_pins AXIS_SWz_0/axi_rdata] [get_bd_pins ps_axil_0/axi_rdata0]
  connect_bd_net -net AXIS_SWz_0_axi_rvalid [get_bd_pins AXIS_SWz_0/axi_rvalid] [get_bd_pins ps_axil_0/axi_rvalid0]
  connect_bd_net -net AXIS_SWz_0_axi_wready [get_bd_pins AXIS_SWz_0/axi_wready] [get_bd_pins ps_axil_0/axi_wready0]
  connect_bd_net -net IO_SERDESz_0_axi_arready [get_bd_pins IO_SERDESz_0/axi_arready] [get_bd_pins ps_axil_0/axi_arready2]
  connect_bd_net -net IO_SERDESz_0_axi_awready [get_bd_pins IO_SERDESz_0/axi_awready] [get_bd_pins ps_axil_0/axi_awready2]
  connect_bd_net -net IO_SERDESz_0_axi_rdata [get_bd_pins IO_SERDESz_0/axi_rdata] [get_bd_pins ps_axil_0/axi_rdata2]
  connect_bd_net -net IO_SERDESz_0_axi_rvalid [get_bd_pins IO_SERDESz_0/axi_rvalid] [get_bd_pins ps_axil_0/axi_rvalid2]
  connect_bd_net -net IO_SERDESz_0_axi_wready [get_bd_pins IO_SERDESz_0/axi_wready] [get_bd_pins ps_axil_0/axi_wready2]
  connect_bd_net -net IO_SERDESz_0_serial_tclk [get_bd_pins IO_SERDESz_0/serial_tclk] [get_bd_pins ps_is_wrapper_0/ps_is_tclk]
  connect_bd_net -net IO_SERDESz_0_serial_txd [get_bd_pins IO_SERDESz_0/serial_txd] [get_bd_pins ps_is_wrapper_0/ps_is_txd]
  connect_bd_net -net aa_wrapper_0_s_arready [get_bd_pins aa_wrapper_0/s_arready] [get_bd_pins ps_axil_0/axi_arready1]
  connect_bd_net -net aa_wrapper_0_s_awready [get_bd_pins aa_wrapper_0/s_awready] [get_bd_pins ps_axil_0/axi_awready1]
  connect_bd_net -net aa_wrapper_0_s_rdata [get_bd_pins aa_wrapper_0/s_rdata] [get_bd_pins ps_axil_0/axi_rdata1]
  connect_bd_net -net aa_wrapper_0_s_rvalid [get_bd_pins aa_wrapper_0/s_rvalid] [get_bd_pins ps_axil_0/axi_rvalid1]
  connect_bd_net -net aa_wrapper_0_s_wready [get_bd_pins aa_wrapper_0/s_wready] [get_bd_pins ps_axil_0/axi_wready1]
  ...
  connect_bd_net -net caravel_0_mprj_o [get_bd_pins caravel_0/mprj_o] [get_bd_pins ps_is_wrapper_0/caravel_mprj_out]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins IO_SERDESz_0/ioclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins ps_is_wrapper_0/ps_ioclk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins AXIS_SWz_0/axis_clk] [get_bd_pins IO_SERDESz_0/axi_clk] [get_bd_pins IO_SERDESz_0/axis_clk] [get_bd_pins aa_wrapper_0/axi_clk] [get_bd_pins aa_wrapper_0/axis_clk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins caravel_0/clock] [get_bd_pins caravel_ps_0/ap_clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins output_pin_0/ap_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps_axil_0/axi_clk] [get_bd_pins read_romcode_0/ap_clk] [get_bd_pins rst_ps7_0_10M/slowest_sync_clk] [get_bd_pins spiflash_0/ap_clk]
  ...
  connect_bd_net -net ps_axil_0_aa_enable [get_bd_pins aa_wrapper_0/cc_aa_enable] [get_bd_pins ps_axil_0/aa_enable]
  connect_bd_net -net ps_axil_0_as_enable [get_bd_pins AXIS_SWz_0/cc_as_enable] [get_bd_pins ps_axil_0/as_enable]
  connect_bd_net -net ps_axil_0_axi_araddr [get_bd_pins AXIS_SWz_0/axi_araddr] [get_bd_pins IO_SERDESz_0/axi_araddr] [get_bd_pins aa_wrapper_0/s_araddr] [get_bd_pins ps_axil_0/axi_araddr]
  connect_bd_net -net ps_axil_0_axi_arvalid [get_bd_pins AXIS_SWz_0/axi_arvalid] [get_bd_pins IO_SERDESz_0/axi_arvalid] [get_bd_pins aa_wrapper_0/s_arvalid] [get_bd_pins ps_axil_0/axi_arvalid]
  connect_bd_net -net ps_axil_0_axi_awaddr [get_bd_pins AXIS_SWz_0/axi_awaddr] [get_bd_pins IO_SERDESz_0/axi_awaddr] [get_bd_pins aa_wrapper_0/s_awaddr] [get_bd_pins ps_axil_0/axi_awaddr]
  connect_bd_net -net ps_axil_0_axi_awvalid [get_bd_pins AXIS_SWz_0/axi_awvalid] [get_bd_pins IO_SERDESz_0/axi_awvalid] [get_bd_pins aa_wrapper_0/s_awvalid] [get_bd_pins ps_axil_0/axi_awvalid]
  connect_bd_net -net ps_axil_0_axi_rready [get_bd_pins AXIS_SWz_0/axi_rready] [get_bd_pins IO_SERDESz_0/axi_rready] [get_bd_pins aa_wrapper_0/s_rready] [get_bd_pins ps_axil_0/axi_rready]
  connect_bd_net -net ps_axil_0_axi_wdata [get_bd_pins AXIS_SWz_0/axi_wdata] [get_bd_pins IO_SERDESz_0/axi_wdata] [get_bd_pins aa_wrapper_0/s_wdata] [get_bd_pins ps_axil_0/axi_wdata]
  connect_bd_net -net ps_axil_0_axi_wstrb [get_bd_pins AXIS_SWz_0/axi_wstrb] [get_bd_pins IO_SERDESz_0/axi_wstrb] [get_bd_pins aa_wrapper_0/s_wstrb] [get_bd_pins ps_axil_0/axi_wstrb]
  connect_bd_net -net ps_axil_0_axi_wvalid [get_bd_pins AXIS_SWz_0/axi_wvalid] [get_bd_pins IO_SERDESz_0/axi_wvalid] [get_bd_pins aa_wrapper_0/s_wvalid] [get_bd_pins ps_axil_0/axi_wvalid]
  connect_bd_net -net ps_axil_0_is_enable [get_bd_pins IO_SERDESz_0/cc_is_enable] [get_bd_pins ps_axil_0/is_enable]
  connect_bd_net -net ps_is_wrapper_0_caravel_mprj_in [get_bd_pins caravel_0/mprj_i] [get_bd_pins ps_is_wrapper_0/caravel_mprj_in]
  connect_bd_net -net ps_is_wrapper_0_ps_is_rclk [get_bd_pins IO_SERDESz_0/serial_rclk] [get_bd_pins ps_is_wrapper_0/ps_is_rclk]
  connect_bd_net -net ps_is_wrapper_0_ps_is_rxd [get_bd_pins IO_SERDESz_0/serial_rxd] [get_bd_pins ps_is_wrapper_0/ps_is_rxd]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXIS_SWz_0/axi_reset_n] [get_bd_pins AXIS_SWz_0/axis_rst_n] [get_bd_pins IO_SERDESz_0/axi_reset_n] [get_bd_pins IO_SERDESz_0/axis_rst_n] [get_bd_pins aa_wrapper_0/axi_reset_n] [get_bd_pins aa_wrapper_0/axis_rst_n] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins caravel_ps_0/ap_rst_n] [get_bd_pins output_pin_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps_axil_0/axi_reset_n] [get_bd_pins read_romcode_0/ap_rst_n] [get_bd_pins rst_ps7_0_10M/peripheral_aresetn]
