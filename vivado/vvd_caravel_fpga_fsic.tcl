...
#
# Generated by Vivado on Wed Oct 25 16:05:46 CST 2023
...
# module references:
# caravel, ps_axil, ps_is_wrapper, spiflash
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins ps_axil_0/is_ioclk] [get_bd_pins ps_is_wrapper_0/ps_ioclk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins caravel_0/clock] [get_bd_pins caravel_ps_0/ap_clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins output_pin_0/ap_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps_axil_0/axi_clk] [get_bd_pins ps_axil_0/axis_clk] [get_bd_pins read_romcode_0/ap_clk] [get_bd_pins rst_ps7_0_10M/slowest_sync_clk] [get_bd_pins spiflash_0/ap_clk]
  ...
  connect_bd_net -net ps_axil_0_is_serial_tclk [get_bd_pins ps_axil_0/is_serial_tclk] [get_bd_pins ps_is_wrapper_0/ps_is_tclk]
  connect_bd_net -net ps_axil_0_is_serial_txd [get_bd_pins ps_axil_0/is_serial_txd] [get_bd_pins ps_is_wrapper_0/ps_is_txd]
  ...
  connect_bd_net -net ps_is_wrapper_0_ps_is_rclk [get_bd_pins ps_axil_0/is_serial_rclk] [get_bd_pins ps_is_wrapper_0/ps_is_rclk]
  connect_bd_net -net ps_is_wrapper_0_ps_is_rxd [get_bd_pins ps_axil_0/is_serial_rxd] [get_bd_pins ps_is_wrapper_0/ps_is_rxd]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins caravel_ps_0/ap_rst_n] [get_bd_pins output_pin_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps_axil_0/axi_reset_n] [get_bd_pins ps_axil_0/axi_rst_n] [get_bd_pins read_romcode_0/ap_rst_n] [get_bd_pins rst_ps7_0_10M/peripheral_aresetn]
